...
function pagination_item_active(&$item)
{
	...
	{
		$display = '<i class="glyphicon glyphicon-step-backward"></i>';
	}
	...
	{
		$display = '<i class="glyphicon glyphicon-step-forward"></i>';
	}
...
function pagination_item_inactive(&$item)
{
	...
	if ($item->text == JText::_('JLIB_HTML_START'))
	{
		return '<li class="disabled"><a><i class="glyphicon glyphicon-step-backward"></i></a></li>';
	}
	...
	if ($item->text == JText::_('JLIB_HTML_END'))
	{
		return '<li class="disabled"><a><i class="glyphicon glyphicon-step-forward"></i></a></li>';
	}
