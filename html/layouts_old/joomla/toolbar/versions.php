...
<a rel="{handler: 'iframe', size: {x: <?php echo $displayData['height']; ?>, y: <?php echo $displayData['width']; ?>}}"
	...
	title="<?php echo $displayData['title']; ?>" class="btn btn-default btn-sm modal_jform_contenthistory">
	<i class="glyphicon glyphicon-briefcase"></i> <?php echo $displayData['title']; ?>
</a>
