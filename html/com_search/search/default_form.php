...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
	...
	<div class="btn-toolbar form-group">
		...
		<div class="btn-group pull-left">
			<button name="Search" onclick="this.form.submit()" class="btn btn-submit hasTooltip" title="<?php echo JHtml::tooltipText('COM_SEARCH_SEARCH');?>"><span class="glyphicon glyphicon-search">Search</span></button>
		</div>
	...
	<?php if ($this->params->get('search_areas', 1)) : ?>
		<fieldset class="only form-group">
