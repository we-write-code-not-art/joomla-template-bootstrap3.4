...
?>
<div class="logout<?php echo $this->pageclass_sfx?> well-lg">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.logout'); ?>" method="post" class="text-center well">
		...
		<div class="form-group">
			...
			<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> <?php echo JText::_('JLOGOUT'); ?></button>
		</div>
