...
<form id="member-profile" action="<?php echo JRoute::_('index.php?option=com_users&task=profile.save'); ?>" method="post" class="form-validate form-horizontal" role="form" enctype="multipart/form-data">
			...
			<?php else:?>
				<div class="form-group">
					<div class="col-sm-2 control-label">
						...
						<span class="optional" title="&lt;strong&gt;"><?php echo JText::_('COM_USERS_OPTIONAL'); ?></span>
						<?php endif; ?>
					</div>
					<div class="col-sm-10">
						<?php 
