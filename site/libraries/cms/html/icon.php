...
{
	public static function contact_email($contact, $params, $attribs = array())
	{
	...
	public static function contact_print_popup($article, $params, $attribs = array())
	{
	...
	public static function contact_print_screen($contact, $params, $attribs = array())
	{
		// Checks template image directory for image, if non found default are loaded
		if ($params->get('show_icons'))
		{
	 ...
	 */
	public static function content_create($category, $params, $attribs = array(), $legacy = false)
	{
		...
		if ($params->get('show_icons'))
		{
			...
			{
				$text = '<span class="glyphicon glyphicon-file"></span>&#160;' . JText::_('JNEW') . '&#160;';
			}
		}
		else
		{
	 ...
	 */
	public static function content_email($article, $params, $attribs = array(), $legacy = false)
	{
		require_once JPATH_SITE . '/components/com_mailto/helpers/mailto.php';
	 ...
	 * @since   1.6
	 */
	public static function content_edit($article, $params, $attribs = array(), $legacy = false)
	{
		...
		else
		{
			...
			$text = '<span class="hasTooltip glyphicon glyphicon-' . $icon . ' tip" title="' . JHtml::tooltipText(JText::_('COM_CONTENT_EDIT_ITEM'), $overlib, 0) . '"></span>&#160;' . JText::_('JGLOBAL_EDIT') . '&#160;';
		}
	 ...
	 */
	public static function content_print_popup($article, $params, $attribs = array(), $legacy = false)
	{
	 ...
	 * @return  string  The HTML markup for the popup link
	 */
	public static function content_print_screen($article, $params, $attribs = array(), $legacy = false)
	{
