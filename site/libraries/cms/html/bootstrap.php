...
abstract class JHtmlBootstrap
{
	...
	public static function startAccordion($selector = 'myAccordian', $params = array())
	{
		...
		return '<div id="' . $selector . '" class="panel-group">';
	}
	...
	public static function addSlide($selector, $text, $id, $class = '')
	{
		...
		$html = '<div class="panel panel-default' . $class . '">'
			...
			. '<h4 class="panel-title"><a href="#' . $id . '" data-parent="#' . $selector . '" data-toggle="collapse" aria-expanded="true" aria-controls="collapseOne">'
			. $text
			. '</a></strong>'
			. '</div>'
